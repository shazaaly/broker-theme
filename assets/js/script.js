$(function () {
  ...
  $("#mission span.carousel-control-next-icon").click(function(){
   $("#mission .title-parag").html('أفضل مولات العاصمة الإداريه  بمساحات أكثر من 2 فدان و تحتوي على عيادات و تجاري و طبي ').fadeIn(2000);
    
   $("#mission span.carousel-control-next-icon").click(function(){
    $("#mission .title-parag").fadeIn(2000).html('أفضل مولات العاصمة الإداريه  بمساحات أكثر من 2 فدان و تحتوي على عيادات و تجاري و طبي ').fadeIn(2000);
    ...
    $("#mission span.carousel-control-next-icon").click(function(){
      ...
      $("#mission span.carousel-control-next-icon").click(function(){
        $("#mission .title-parag").fadeIn(2000).html(' يحتوي الحى السكنى على 25 ألف وحدة سكنية، بمساحات تتراوح من 130 إلى 180 مترًا مربعًا للوحدة.) لكل طابق، ويختلف مسطح كل وحدة حيث يبدأ من (130 مترًا مربعًا) وحتى (180 مترًا مربعًا) شامل الخدمات. تتكون الشقة من 3 غرف و2 حمام ومطبخ له شرفة وحجرة نوم بحمام مستقل ومساحة للاستقبال. يتكون كل طابق في المبنى السكني من 4 شقق سكنية و2 مصعد. ');
       
        });

        $("#mission .rec-buttons-next").click(function(){
          $("#mission .title-parag").html(' يختلف مسطح كل وحدة حيث يبدأ من (130 مترًا مربعًا) وحتى (180 مترًا مربعًا) شامل الخدمات. تتكون الشقة من 3 غرف و2 حمام ومطبخ له شرفة وحجرة نوم بحمام مستقل ومساحة للاستقبال. يتكون كل طابق في المبنى السكني من 4 شقق سكنية و2 مصعد. ');
